...
func (n MessageEventNormalizer) NormalizeMessage(instanceID int64, event *waevents.Message) (dbtypes.CreateMessageInput, error) {
	if event == nil {
...
func (n MessageEventNormalizer) NormalizeFBMessage(instanceID int64, event *waevents.FBMessage) (dbtypes.CreateMessageInput, error) {
	if event == nil {
...
func (n MessageEventNormalizer) normalizeFromInfo(instanceID int64, info watypes.MessageInfo, content normalizedContent, metadata json.RawMessage) dbtypes.CreateMessageInput {
