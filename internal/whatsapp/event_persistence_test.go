...
func TestHandleReceiptFindsMessageByInstanceAndKeyWithRetry(t *testing.T) {
	...
	}, messages, updates, &fakePersistenceContacts{})

	service.HandleReceipt(context.Background(), eventManagedClient(), receiptEvent("msg-1", time.Unix(10, 0).UTC()))
...
func TestHandleReceiptFlagDisabledDoesNotCallRepositories(t *testing.T) {
	messages := &fakePersistenceMessages{}
	updates := &fakePersistenceMessageUpdates{}
	service := NewEventPersistenceService(EventPersistenceConfig{SaveMessageUpdate: false}, messages, updates, &fakePersistenceContacts{})

	service.HandleReceipt(context.Background(), eventManagedClient(), receiptEvent("msg-1", time.Time{}))
...
func TestFindMessageWithRetryHonorsContextCancellation(t *testing.T) {
	...
	}, messages, &fakePersistenceMessageUpdates{}, &fakePersistenceContacts{})
	ctx, cancel := context.WithCancel(context.Background())
	cancel()

	_, err := service.findMessageWithRetry(ctx, eventRuntimeGrant(), 42, "msg-1")
...
func TestHandleMessageUsesCreateOrIgnore(t *testing.T) {
	messages := &fakePersistenceMessages{}
	service := NewEventPersistenceService(EventPersistenceConfig{SaveDataNewMessage: true}, messages, &fakePersistenceMessageUpdates{}, &fakePersistenceContacts{})

	service.HandleMessage(context.Background(), eventManagedClient(), textEvent("msg-1"))
...
func TestHandleFBMessageDispatchesUpsertWithPersistedID(t *testing.T) {
	...
	service.HandleFBMessage(context.Background(), eventManagedClient(), fbEvent("fb-1"))
...
func TestDispatchMessageDeletedWebhookAddsPersistedIDWhenKnown(t *testing.T) {
	...
	service.dispatchMessageDeletedWebhook(context.Background(), eventManagedClient(), &events.DeleteForMe{MessageID: "msg-1"})
...
func TestHandleReceiptDispatchesMessageUpdateAfterPersist(t *testing.T) {
	...
	service.HandleReceipt(context.Background(), eventManagedClient(), receiptEvent("msg-1", dateTime))
...
func TestHandleReceiptMissingMessageDoesNotDispatch(t *testing.T) {
	...
	service.HandleReceipt(context.Background(), eventManagedClient(), receiptEvent("msg-1", time.Now()))
...
func TestHandleContactDispatchesPersistedContact(t *testing.T) {
	...
	webhooks := &fakePersistenceWebhooks{}
	service := NewEventPersistenceService(EventPersistenceConfig{SaveDataContacts: true}, &fakePersistenceMessages{}, &fakePersistenceMessageUpdates{}, contacts)
	service.SetWebhookDispatcher(fakeInstanceFinder(), webhooks)

	service.HandleContact(context.Background(), eventManagedClient(), contactEvent())
...
func TestHandleBusinessNameDispatchesContactsUpdateWithoutSchemaColumn(t *testing.T) {
	...
	service.HandleBusinessName(context.Background(), eventManagedClient(), businessNameEvent())
...
func eventRuntimeGrant() security.Grant {
	return security.SystemGrant(authz.ActionRuntime, "acme")
}

func eventManagedClient() *ManagedWhatsAppClient {
...
func (f *fakePersistenceMessages) Create(context.Context, security.Grant, dbtypes.CreateMessageInput) (dbtypes.Message, error) {
	return dbtypes.Message{}, nil
}

func (f *fakePersistenceMessages) CreateOrIgnore(_ context.Context, _ security.Grant, input dbtypes.CreateMessageInput) error {
	f.createOrIgnoreCalls++
	f.created = input
	return f.createErr
}

func (f *fakePersistenceMessages) FindByIDForInstance(context.Context, security.Grant, int64, int64) (dbtypes.Message, error) {
	return dbtypes.Message{}, repository.ErrMessageNotFound
}

func (f *fakePersistenceMessages) FindByKeyIDForInstance(_ context.Context, _ security.Grant, instanceID int64, keyID string) (dbtypes.Message, error) {
	f.findCalls++
...
func (f *fakePersistenceMessages) FindByIDsForInstance(context.Context, security.Grant, int64, []int64) ([]dbtypes.Message, error) {
	return nil, nil
}

func (f *fakePersistenceMessages) FindOutgoingByIDForInstance(context.Context, security.Grant, int64, int64) (dbtypes.Message, error) {
	return dbtypes.Message{}, nil
}

func (f *fakePersistenceMessages) FindOutgoingByKeyIDForInstance(context.Context, security.Grant, int64, string) (dbtypes.Message, error) {
	return dbtypes.Message{}, nil
}

func (f *fakePersistenceMessages) MarkReadForInstance(context.Context, security.Grant, int64, []int64) error {
	return nil
}

func (f *fakePersistenceMessages) UpdateContentForInstance(context.Context, security.Grant, int64, int64, json.RawMessage) (dbtypes.Message, error) {
	return dbtypes.Message{}, nil
}

func (f *fakePersistenceMessages) Count(context.Context, security.Grant, int64, dbtypes.MessageFilters) (int64, error) {
	return 0, nil
}

func (f *fakePersistenceMessages) List(context.Context, security.Grant, int64, dbtypes.ListMessagesInput) (dbtypes.MessageListResult, error) {
	return dbtypes.MessageListResult{}, nil
}

func (f *fakePersistenceMessages) ListPage(context.Context, security.Grant, int64, dbtypes.ListMessagesPageInput) (dbtypes.MessageListResult, error) {
	return dbtypes.MessageListResult{}, nil
}
...
func (f *fakePersistenceMessageUpdates) Create(context.Context, security.Grant, dbtypes.CreateMessageUpdateInput) (dbtypes.MessageUpdate, error) {
	return dbtypes.MessageUpdate{}, nil
}

func (f *fakePersistenceMessageUpdates) CreateOrIgnore(_ context.Context, _ security.Grant, input dbtypes.CreateMessageUpdateInput) error {
	f.createCalls++
	f.input = input
	return nil
}

func (f *fakePersistenceMessageUpdates) ListByMessageID(context.Context, security.Grant, int64) ([]dbtypes.MessageUpdate, error) {
	return nil, nil
}
...
func (f *fakePersistenceContacts) Create(context.Context, security.Grant, dbtypes.CreateContactInput) (dbtypes.Contact, error) {
	return dbtypes.Contact{}, nil
}

func (f *fakePersistenceContacts) Upsert(_ context.Context, _ security.Grant, input dbtypes.CreateContactInput) (dbtypes.Contact, error) {
	f.upsertCalls++
	f.input = input
	if f.err != nil {
...
func (f *fakePersistenceContacts) List(context.Context, security.Grant, int64, dbtypes.ContactFilters) ([]dbtypes.Contact, error) {
	return nil, nil
}
...
func persistedTextMessage(id int64, keyID string) dbtypes.Message {
	isGroup := false
...
func persistedFBMessage(id int64, keyID string) dbtypes.Message {
	isGroup := false
	return dbtypes.Message{
		ID:               id,
		KeyID:            keyID,
...
func (f *fakePersistenceWebhooks) Dispatch(_ context.Context, _ security.Grant, instance webhooksvc.WebhookInstance, event dbtypes.WebhookEvent, data any) error {
	f.dispatchCalls++
	f.instance = instance
	f.event = event
	f.data = data
...
type fakePersistenceInstanceFinder struct {
	instance dbtypes.InstanceRecord
	err      error
}

func fakeInstanceFinder() fakePersistenceInstanceFinder {
	owner := "5531999999999@s.whatsapp.net"
	return fakePersistenceInstanceFinder{instance: dbtypes.InstanceRecord{Instance: dbtypes.Instance{
		ID:                 42,
		Name:               "beplus",
...
func (f fakePersistenceInstanceFinder) FindByName(context.Context, security.Grant, string) (dbtypes.InstanceRecord, error) {
	if f.err != nil {
		return dbtypes.InstanceRecord{}, f.err
	}
